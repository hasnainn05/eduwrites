        ...
        <div className="prose prose-invert max-w-none space-y-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside text-foreground/80 space-y-2">
                  <li>Name, email address, phone number, and WhatsApp contact information</li>
                  <li>Academic level, subject matter, and assignment details</li>
          ...
          <section>
            ...
            <p className="text-foreground/80">
              ...
              the purposes outlined in this Privacy Policy. You can request deletion of your account and 
              associated data at any time, subject to applicable legal requirements.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground/80">
              ...
              to our website. We encourage you to review this policy periodically to stay informed about 
