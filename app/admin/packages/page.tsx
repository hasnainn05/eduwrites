...
export default function AdminPackages() {
  ...
  const [editFormData, setEditFormData] = useState<typeof packages[0] | null>(null);
      ...
      <div className="flex-1 ml-64 overflow-y-auto">
        ...
        <div className="sticky top-0 z-40 bg-gradient-to-r from-slate-900/95 to-slate-800/95 backdrop-blur border-b border-white/10 p-6">
          <div>
            ...
            <p className="text-foreground/60 text-sm mt-1">Manage service packages and pricing (Basic, Medium, Premium)</p>
          </div>
        </div>
        ...
        <div className="p-6">
          {editingId ? (
            ...
            <div className="glass rounded-2xl border border-white/10 p-8">
              {editFormData && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-8">Edit {editFormData.name} Package</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-foreground/80 mb-2">CTA Button Text</label>
                      <input
                        type="text"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <label className="text-sm font-medium text-foreground/80">Mark as Most Popular</label>
                    </div>

                    {/* Features */}
                    <div>
                      <label className="block text-sm font-medium text-foreground/80 mb-4">Package Features</label>
              ...
              {packages.map((pkg) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* CTA */}
                    <button className={`w-full py-3 rounded-lg font-semibold mb-4 transition-all ${
                      pkg.popular
