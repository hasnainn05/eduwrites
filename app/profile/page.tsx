  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-background via-background/95 to-background/80">
      ...
      <div className="flex min-h-screen">
        ...
        {/* Main Content */}
        <div className="fixed left-64 right-0 top-16 bottom-24 flex flex-col overflow-hidden">
          {/* Mode Toggle - Fixed at Top Outside Scroll */}
          <div className="flex justify-center py-4 bg-gradient-to-b from-background/80 to-transparent backdrop-blur-sm border-b border-white/10">
