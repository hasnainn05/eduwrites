          ...
          <div className="hidden lg:block">
            ...
            <div className="space-y-4 mb-8">
              <div className="glass p-5 rounded-xl hover:bg-white/20 transition-all">
                ...
                <p className="text-sm text-foreground/70">Professional essays for all academic levels, perfectly crafted and researched</p>
              </div>
              ...
              <div className="glass p-5 rounded-xl hover:bg-white/20 transition-all">
                ...
                <p className="text-sm text-foreground/70">In-depth analysis and comprehensive research with proper citations</p>
              </div>
              ...
              <div className="glass p-5 rounded-xl hover:bg-white/20 transition-all">
                ...
                <p className="text-sm text-foreground/70">Expert support for your most important academic projects</p>
              </div>
              ...
              <div className="glass p-5 rounded-xl hover:bg-white/20 transition-all">
                ...
                <p className="text-sm text-foreground/70">Polish your work to perfection with our expert editing services</p>
              </div>
            </div>

            <div className="glass p-6 rounded-2xl border border-white/20">
              <p className="text-sm text-foreground/80 mb-4">
                <strong className="text-cyan-400 block mb-2">🌟 Join 10,000+ Students</strong> who trust Ardelis for academic success
              </p>
