      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              {
                title: "Improved GPA from 2.8 to 3.8",
                category: "Academic Transformation",
                student: "Sarah M.",
                description: "Used our essay writing service to understand proper academic structure. Within one semester, her grades improved dramatically, raising her overall GPA significantly and opening doors for scholarships.",
                result: "+1.0 GPA",
                icon: "📈",
              },
              {
                title: "Met Critical Deadline",
                category: "Time Management",
                student: "John D.",
                description: "Juggling work and school, John used our services to meet multiple tight deadlines without compromising quality. Completed semester with distinction and on time.",
                result: "On Time",
                icon: "⏰",
              },
              {
                title: "First Class Honours Achievement",
                category: "Academic Excellence",
                student: "Priya K.",
                description: "Struggled with research papers until finding our service. Expert guidance and original research support helped her achieve first-class honours in her final year.",
                result: "1st Class",
                icon: "🏆",
              },
              {
                ...
                student: "Michael T.",
                description: "Our thesis writing support helped Michael produce outstanding work that impressed admissions committees. He's now pursuing his master's degree at a top university.",
                result: "Admitted",
                icon: "🎓",
              },
              {
                title: "Confidence in Writing Skills",
                category: "Personal Development",
                student: "Emma L.",
                description: "Through our proofreading service, Emma learned professional writing standards and editing techniques. She now confidently handles all her academic writing independently.",
                result: "Skill Built",
                icon: "💪",
              },
              {
                title: "Full-Time Job + Study Balance",
                category: "Work-Life Balance",
                student: "David H.",
                description: "Working full-time while studying, David needed reliable support. Our timely assignments and high-quality work helped him maintain balance and graduate successfully.",
                result: "Success",
                icon: "✅",
              },
            ].map((project, index) => (
