        ...
        <div className="max-w-6xl mx-auto w-full flex items-center justify-between gap-1 sm:gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 flex-shrink-0">
            <div className="hidden lg:flex flex-col gap-2 text-[11px]">
              ...
              <div className="flex items-center gap-1.5 text-foreground/80 hover:text-green-600 transition-colors">
                <a
                ...
                >
                  ...
                  >
                    <path d="M17.472 14.869c-.469-.469-1.429-.469-1.898 0l-.913.913c-.141.141-.371.125-.52.012-1.143-.822-2.883-2.64-3.705-3.783-.112-.149-.129-.379.012-.52l.913-.913c.469-.469.469-1.429 0-1.898l-2.933-2.933c-.469-.469-1.429-.469-1.898 0L4.413 5.539c-.469.469-.469 1.429 0 1.898 3.365 3.365 6.231 6.231 9.596 9.596.469.469 1.429.469 1.898 0l1.898-1.898c.469-.469 1.429-.469 1.898 0l2.933 2.933c.469.469.469 1.429 0 1.898l-1.898 1.898c-.469.469-1.429.469-1.898 0l-2.933-2.933z" />
                    <path d="M20.487 3.513C18.369 1.396 15.586 0.25 12.5 0.25c-6.213 0-11.25 5.037-11.25 11.25s5.037 11.25 11.25 11.25 11.25-5.037 11.25-11.25c0-3.086-1.146-5.869-3.263-7.987z" fill="none" stroke="currentColor" strokeWidth="1.5" />
                  </svg>
