          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 flex-shrink-0">
            ...
            <div className="hidden sm:flex gap-1.5 items-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-[#25D366] text-white rounded-lg hover:bg-[#20BA5B] transition-all text-[9px] sm:text-[10px] font-semibold hover:scale-105 whitespace-nowrap flex items-center gap-1.5"
              >
                <svg
                  width="14"
                  height="14"
